  ...
  return (
    <>
      <div className='flex flex-col justify-center text-center items-center relative overflow-y-scroll scrollbar-hide'>
          ...
          <div className='flex flex-col w-screen h-screen px-7 md:px-26 xl:px-44 relative gap-10 mb-10'>
            ...
            <div className='flex flex-col mt-7 xl:mt-14 px-10 2xl:mt-30'>
              ...
              <div className='flex flex-col xl:flex-row mt-5 2xl:mt-8 gap-7'>
                ...
                <div className='flex flex-col xl:flex-1 items-start justify-start bg-linear-br from-[#ECFDF5]/80 to-[#FFFFFF]/50 px-6 py-5 gap-3 rounded-3xl mb-10'>
